      ...
      var r = (function () {
        ...
        G = function (A, e, t, r, n) {
          ...
          if (
            ...
            return T;
          if (
            (a === H && -1 !== [N, p, K].indexOf(D)) ||
            (-1 !== [N, p, K].indexOf(a) && D === d)
          )
            return T;
          if (
                  ...
                  value: function (A) {
                    ...
                    if (A >= 0) {
                      if (A < 55296 || (A > 56319 && A <= 65535))
                        return (
                          (e = ((e = this.index[A >> B]) << o) + (A & Q)),
                          this.data[e]
                        );
                      if (A <= 65535)
                        return (
                          (e =
                            ((e = this.index[i + ((A - 55296) >> B)]) << o) +
                            (A & Q)),
                          this.data[e]
                        );
                      if (A < this.highStart)
    ...
    function (A, e, t) {
        ...
        U = (function () {
          function A(e) {
            ...
            var t = (function (A, e) {
                ...
                Array.isArray(e)
                  ? w(e)
                  : s(e) || c(e) || l(e) || u(e) || a(e) || [0, 0, 0, null],
                4
              ),
              r = t[0],
              n = t[1],
      ...
      var H = function (A, e) {
          ...
          A.colorStops.forEach(function (A) {
            e.addColorStop(
              Math.floor(Math.max(0, r * A.stop)),
              A.color.toString()
            );
          });
        },
                      ...
                      if (
                        ...
                        r.textDecorationLine.forEach(function (e) {
                          switch (e) {
                            case 1:
                              var r =
                                B.options.fontMetrics.getMetrics(t).baseline;
                              B.rectangle(
                                A.bounds.left,
                            ...
                            case 3:
                              var n =
                                B.options.fontMetrics.getMetrics(t).middle;
                              B.rectangle(
                                A.bounds.left,
        ...
        v = (function () {
          function A(e) {
            !(function (A, e) {
              ...
              (this.type =
                "%" === e.substr(e.length - 1) ? y.PERCENTAGE : y.PX);
            var t = parseFloat(e);
            ...
            })(A, [
              {
                ...
                value: function (e, t) {
                  var r = S(this.start, this.startControl, e),
                    ...
                    a = S(s, o, e);
                  return t
                    ? new A(this.start, r, s, a)
                    : new A(a, o, B, this.end);
                },
              },
              {
                key: "reverse",
      ...
      var L = (function () {
        ...
        oA = Object.keys({ TOP: 0, RIGHT: 1, BOTTOM: 2, LEFT: 3 }).map(
          function (A) {
        ...
        yA = function (A) {
          ...
          for (
            var e = "",
              ...
              s = null,
              o = function () {
                e.length && (t ? r.push(parseFloat(e)) : (s = new U(e))),
                  (t = !1),
                  (e = "");
              },
              a = function () {
      ...
      var xA = (function () {
        ...
        RA = {
          get SUPPORT_RANGE_BOUNDS() {
            ...
            return (
              Object.defineProperty(RA, "SUPPORT_RANGE_BOUNDS", { value: A }), A
            );
          },
          get SUPPORT_SVG_DRAWING() {
            ...
            return (
              Object.defineProperty(RA, "SUPPORT_SVG_DRAWING", { value: A }), A
            );
          },
          get SUPPORT_FOREIGNOBJECT_DRAWING() {
            var A =
              ...
              "function" == typeof window.fetch
                    ...
                    return (
                      ...
                      kA(B)
                        ...
                        .then(function (A) {
                          return (
                            t.drawImage(A, 0, 0),
                            JA(t.getImageData(0, 0, 100, 100).data)
                          );
                        })
                        .catch(function (A) {
                          return !1;
                ...
                : Promise.resolve(!1);
            return (
              Object.defineProperty(RA, "SUPPORT_FOREIGNOBJECT_DRAWING", {
                value: A,
              }),
              A
            );
          ...
          get SUPPORT_CORS_IMAGES() {
            ...
            return (
              Object.defineProperty(RA, "SUPPORT_CORS_IMAGES", { value: A }), A
            );
          },
          get SUPPORT_RESPONSE_TYPE() {
            var A = "string" == typeof new XMLHttpRequest().responseType;
            return (
              Object.defineProperty(RA, "SUPPORT_RESPONSE_TYPE", { value: A }),
              A
            );
          },
          get SUPPORT_CORS_XHR() {
            ...
            return (
              Object.defineProperty(RA, "SUPPORT_CORS_XHR", { value: A }), A
            );
          },
        },
        _A = RA,
        ...
        YA = function (A, e, t, r, n) {
          ...
          return (
            B.setStart(A, e),
            B.setEnd(A, e + t),
            L.fromClientRect(B.getBoundingClientRect(), r, n)
          );
        };
      function qA(A, e) {
        for (var t = 0; t < e.length; t++) {
                  ...
                  return new A(
                    ...
                    (function (A, e, t) {
                      for (
                        ...
                        var Q = r[c];
                        if (
                          null !== e.style.textDecoration ||
                          Q.trim().length > 0
                        )
                          if (_A.SUPPORT_RANGE_BOUNDS)
                            a.push(new GA(Q, YA(t, i, Q.length, s, o)));
                          else {
                            var l = t.splitText(Q.length);
                            a.push(new GA(Q, WA(t, s, o))), (t = l);
                          }
                        else
                          _A.SUPPORT_RANGE_BOUNDS ||
                            (t = t.splitText(Q.length));
                        i += Q.length;
                      }
                      return a;
                    })(r, t, e)
          ...
          if (r) {
            ...
            if (a)
              if ("url" === a.method) {
                ...
                (s.style.top = "".concat(
                  e.bounds.top - o + e.bounds.height - 1.5 * c,
                  "px"
                )),
              ...
              "number" == typeof e.listIndex &&
                ((n = A.ownerDocument.createTextNode(
                  Me(e.listIndex, r.listStyleType, !0)
                )),
                s.appendChild(n),
                (s.style.top = "".concat(e.bounds.top - o, "px")));
          ...
          function A(e, t, r, n) {
            ...
            if (
              ((this.style = {
                ...
                overflow:
                  -1 === Se.indexOf(e.tagName) ? pA(i.overflow) : EA.HIDDEN,
            ...
            (function (A, e, t) {
            ...
            })(A, [
              {
                ...
                value: function () {
                  ...
                  return this.style.overflow !== EA.VISIBLE
                    ? A.concat([k(this.curvedBounds)])
                    : A;
                },
              },
              {
              ...
              },
              {
                ...
                value: function () {
                  return (
                    this.style.position !== mA.STATIC &&
                    this.style.position !== mA.RELATIVE
                  );
                },
              },
              {
      ...
      var We = /^(to )?(left|top|right|bottom)( (left|top|right|bottom))?$/i,
          ...
          for (
            ...
            if (null !== Q) {
              ...
              if (null === w) {
                ...
                for (var g = u - l + 1, F = (c[u].stop - Q) / g; l < u; l++)
                  Q = c[l].stop = Q + F;
              } else Q = w;
            }
          return c;
        ...
        tt = function (A, e, t) {
          ...
          r &&
            (void 0 !== r[3] &&
              (B.x = I(A, r[3], r[4]).getAbsoluteValue(t.width)),
            void 0 !== r[5] &&
              (B.y = I(A, r[5], r[6]).getAbsoluteValue(t.height)),
            r[7]
              ? (s.x = $e[r[7].toLowerCase()])
              : void 0 !== r[8] && (s.x = I(A, r[8], r[9])),
            r[10]
      ...
      var wt = (function () {
                        ...
                        if (t) {
                          var r = (function (A, e, t) {
                              ...
                              return new L(
                                ...
                                A.width -
                                  (t[1].borderWidth + t[3].borderWidth + s + n),
                                A.height -
                ...
                value: function (A) {
                  var e = this,
                    ...
                    r = A.style.border.some(function (A) {
                      return (
                        0 !== A.borderStyle && !A.borderColor.isTransparent()
                      );
                    }),
                    n = function () {
                      var r = (function (A, e) {
                  ...
                  if (t) {
                    var r = Z(
                      ...
                      n = (function (A, e, t) {
                        ...
                        return (
                          B[0].value &&
                            (r = B[0].value.getAbsoluteValue(t.width)),
                          0 === B[0].size && 0 === B[1].size
                            ? (n = e.height)
                            : 0 === B[1].size
                            ? (n = (r / e.width) * e.height)
                            : B[1].value &&
                              (n = B[1].value.getAbsoluteValue(t.height)),
        ...
        Ft = function (A, e) {
          ...
          return new Promise(function (r, n) {
            var B =
                _A.SUPPORT_CORS_XHR && _A.SUPPORT_RESPONSE_TYPE
                  ? "blob"
                  : "text",
              s = _A.SUPPORT_CORS_XHR
                ? new XMLHttpRequest()
                : new XDomainRequest();
            if (
              ((s.onload = function () {
            ...
            dt(A, [
              {
                ...
                value: function (A) {
                  ...
                  if (Nt(A))
                    return (
                      (this.cache[A] = vt(A, this.options.imageTimeout || 0)), A
                    );
                  if (!yt(A) || _A.SUPPORT_SVG_DRAWING) {
                    ...
                    if (!this.isSameOrigin(A)) {
                      if ("string" == typeof this.options.proxy)
                        return (
                          (this.cache[A] = Ft(A, this.options).then(function (
                            A
                          ) {
      ...
      var Lt = (function () {
        ...
        Ot = function (A, e) {
          return (A.cssRules ? Array.from(A.cssRules) : [])
            ...
            .map(function (A) {
              for (
                var t = sA(A.style.getPropertyValue("src")), r = [], n = 0;
                n < t.length;
                n++
              )
                if (
      ...
      var er = function A(e, t, r) {
        var n = e.ownerDocument,
          ...
          s = n.documentElement
            ? new U(getComputedStyle(n.documentElement).backgroundColor)
            : F,
                ...
                return A.inlineFonts(n)
                  ...
                  .then(function () {
                    ...
                    return B.render({
                      ...
                      width:
                        "number" == typeof t.width ? t.width : Math.ceil(Q),
                      height:
                  ...
                  var B = n.contentWindow,
                    ...
                    c = Ar(n).then(function () {
                      ...
                      var t = Promise.resolve([
                        ...
                        o = r.onclone;
                      return s.clonedReferenceElement instanceof
                        B.HTMLElement ||
                      ...
                      (function A(e, t, r, n, B) {
                        for (var s, o = e.firstChild; o; o = s) {
                          ...
                          if (
                            ...
                            o.data.trim().length > 0 &&
                              t.childNodes.push(jA.fromTextNode(o, t));
                          else if (
                            ...
                            if (-1 === xe.indexOf(o.nodeName)) {
                              ...
                              if (i.isVisible()) {
                                ...
                                if (Q || ke(i)) {
                                  ...
                                  r.children.push(i), c && A(o, i, r, n, B);
                              }
                            }
                          } else if (
                  ...
                  o.ready().then(function (A) {
                    var e = new _e(c),
                      ...
                      C = {
                        ...
                        width:
                          "number" == typeof t.width ? t.width : Math.ceil(u),
                        height:
                          "number" == typeof t.height ? t.height : Math.ceil(U),
                      };
