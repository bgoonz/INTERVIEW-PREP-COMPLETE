...
canvas1.pack()
label1 = tk.Label(
    root, text="File Converter", bg="lightsteelblue2"
...
bg = "royalblue"
fg = "white"
browseButton_JPG = tk.Button(
    text="      Import JPEG File     ", command=getJPG, bg=bg, fg=fg, font=font
)  # Browse button
...
saveAsButton_PNG = tk.Button(
    text="Convert JPEG to PNG", command=convertToPNG, bg=bg, fg=fg, font=font
)  # Convert button
