      ...
      return tslib_1.__generator(this, function (_b) {
        switch (_b.label) {
          ...
          case 1:
            ...
            return [
              4 /*yield*/,
              dom_1.extractFaceTensors(this.input, detections),
            ];
          case 2:
            _a = _b.sent();
            return [3 /*break*/, 5];
          ...
          case 6:
            ...
            return [
              ...
              parentResults.map(function (parentResult, i) {
                return WithFaceLandmarks_1.extendWithFaceLandmarks(
                  parentResult,
                  faceLandmarksByFace[i]
                );
              }),
            ];
        }
      ...
      return tslib_1.__generator(this, function (_b) {
        switch (_b.label) {
          ...
          case 1:
            ...
            return [
              4 /*yield*/,
              dom_1.extractFaceTensors(this.input, [detection]),
            ];
          case 2:
            _a = _b.sent();
            return [3 /*break*/, 5];
          ...
          case 6:
            ...
            return [
              2 /*return*/,
              WithFaceLandmarks_1.extendWithFaceLandmarks(
                parentResult,
                landmarks
              ),
            ];
