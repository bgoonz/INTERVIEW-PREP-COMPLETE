...
var DetectAllFacesTask = /** @class */ (function (_super) {
      ...
      return tslib_1.__generator(this, function (_b) {
        switch (_b.label) {
          case 0:
            ...
            if (!(options instanceof MtcnnOptions_1.MtcnnOptions))
              return [3 /*break*/, 2];
          ...
          case 2:
            faceDetectionFunction =
              options instanceof
              TinyFaceDetectorOptions_1.TinyFaceDetectorOptions
                ? function (input) {
                    return nets_1.nets.tinyFaceDetector.locateFaces(
                      input,
                      options
                    );
                  }
                : options instanceof
                  SsdMobilenetv1Options_1.SsdMobilenetv1Options
                ? function (input) {
                    return nets_1.nets.ssdMobilenetv1.locateFaces(
                      input,
                      options
                    );
                  }
                : options instanceof
                  tfjs_image_recognition_base_1.TfjsImageRecognitionBase
                    .TinyYolov2Options
                ? function (input) {
                    return nets_1.nets.tinyYolov2.locateFaces(input, options);
                  }
                : null;
              ...
              return [
                ...
                res(
                  detections.map(function (detection) {
                    return WithFaceDetection_1.extendWithFaceDetection(
                      {},
                      detection
                    );
                  })
  ...
  DetectAllFacesTask.prototype.withFaceLandmarks = function (
    useTinyLandmarkNet
  ) {
    if (useTinyLandmarkNet === void 0) {
      useTinyLandmarkNet = false;
    }
    return new DetectFaceLandmarksTasks_1.DetectAllFaceLandmarksTask(
...
var DetectSingleFaceTask = /** @class */ (function (_super) {
          ...
          switch (_a.label) {
            ...
            case 1:
              ...
              return [
                ...
                res(
                  detection
                    ? WithFaceDetection_1.extendWithFaceDetection({}, detection)
                    : undefined
                ),
              ];
          }
  ...
  DetectSingleFaceTask.prototype.withFaceLandmarks = function (
    useTinyLandmarkNet
  ) {
    if (useTinyLandmarkNet === void 0) {
      useTinyLandmarkNet = false;
    }
    return new DetectFaceLandmarksTasks_1.DetectSingleFaceLandmarksTask(
