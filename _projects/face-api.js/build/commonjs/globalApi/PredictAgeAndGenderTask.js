...
var PredictAllAgeAndGenderTask = /** @class */ (function (_super) {
      ...
      return tslib_1.__generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 1:
            ...
            return [
              4 /*yield*/,
              extractFacesAndComputeResults_1.extractAllFacesAndComputeResults(
                parentResults,
                this.input,
                function (faces) {
                          ...
                          return [
                            ...
                            Promise.all(
                              faces.map(function (face) {
                                return nets_1.nets.ageGenderNet.predictAgeAndGender(
                                  face
                                );
                              })
                            ),
          ...
          case 2:
            ...
            return [
              ...
              parentResults.map(function (parentResult, i) {
                ...
                return WithAge_1.extendWithAge(
                  WithGender_1.extendWithGender(
                    parentResult,
                    gender,
                    genderProbability
                  ),
  ...
  PredictAllAgeAndGenderTask.prototype.withFaceExpressions = function () {
    return new PredictFaceExpressionsTask_1.PredictAllFaceExpressionsTask(
      this,
      this.input
    );
  };
...
var PredictSingleAgeAndGenderTask = /** @class */ (function (_super) {
      ...
      return tslib_1.__generator(this, function (_b) {
        switch (_b.label) {
          ...
          case 1:
            ...
            return [
              4 /*yield*/,
              extractFacesAndComputeResults_1.extractSingleFaceAndComputeResult(
                parentResult,
                this.input,
                function (face) {
                  return nets_1.nets.ageGenderNet.predictAgeAndGender(face);
                },
                this.extractedFaces
              ),
            ];
  ...
  PredictSingleAgeAndGenderTask.prototype.withFaceExpressions = function () {
    return new PredictFaceExpressionsTask_1.PredictSingleFaceExpressionsTask(
      this,
      this.input
    );
  };
...
var PredictAllAgeAndGenderWithFaceAlignmentTask = /** @class */ (function (
  _super
) {
  ...
  PredictAllAgeAndGenderWithFaceAlignmentTask.prototype.withFaceExpressions =
    function () {
      return new PredictFaceExpressionsTask_1.PredictAllFaceExpressionsWithFaceAlignmentTask(
        this,
        this.input
      );
    };
  PredictAllAgeAndGenderWithFaceAlignmentTask.prototype.withFaceDescriptors =
    function () {
      return new ComputeFaceDescriptorsTasks_1.ComputeAllFaceDescriptorsTask(
        this,
        this.input
      );
    };
...
var PredictSingleAgeAndGenderWithFaceAlignmentTask = /** @class */ (function (
  _super
) {
  ...
  PredictSingleAgeAndGenderWithFaceAlignmentTask.prototype.withFaceExpressions =
    function () {
      return new PredictFaceExpressionsTask_1.PredictSingleFaceExpressionsWithFaceAlignmentTask(
        this,
        this.input
      );
    };
  PredictSingleAgeAndGenderWithFaceAlignmentTask.prototype.withFaceDescriptor =
    function () {
      return new ComputeFaceDescriptorsTasks_1.ComputeSingleFaceDescriptorTask(
        this,
        this.input
      );
    };
