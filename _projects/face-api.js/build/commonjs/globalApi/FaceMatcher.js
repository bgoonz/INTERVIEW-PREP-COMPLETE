...
var FaceMatcher = /** @class */ (function () {
  function FaceMatcher(inputs, distanceThreshold) {
    ...
    this._labeledDescriptors = inputArray.map(function (desc) {
      ...
      if (desc instanceof Float32Array) {
        return new LabeledFaceDescriptors_1.LabeledFaceDescriptors(
          createUniqueLabel(),
          [desc]
        );
      }
  ...
  FaceMatcher.prototype.computeMeanDistance = function (
    queryDescriptor,
    descriptors
  ) {
    return (
      descriptors
        .map(function (d) {
          return euclideanDistance_1.euclideanDistance(d, queryDescriptor);
        })
    ...
    return this.labeledDescriptors
      .map(function (_a) {
        var descriptors = _a.descriptors,
          label = _a.label;
        return new FaceMatch_1.FaceMatch(
          label,
          _this.computeMeanDistance(queryDescriptor, descriptors)
        );
      })
