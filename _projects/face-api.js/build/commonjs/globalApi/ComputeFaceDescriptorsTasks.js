                ...
                function (faces) {
                  return Promise.all(
                    faces.map(function (face) {
                      return nets_1.nets.faceRecognitionNet.computeFaceDescriptor(
                        face
                      );
                    })
                  );
          ...
          case 2:
            ...
            return [
              ...
              descriptors.map(function (descriptor, i) {
                return WithFaceDescriptor_1.extendWithFaceDescriptor(
                  parentResults[i],
                  descriptor
                );
              }),
      ...
      return tslib_1.__generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 2:
            ...
            return [
              2 /*return*/,
              WithFaceDescriptor_1.extendWithFaceDescriptor(
                parentResult,
                descriptor
              ),
            ];
