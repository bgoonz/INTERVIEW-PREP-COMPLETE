...
var SsdMobilenetv1 = /** @class */ (function (_super) {
  ...
  SsdMobilenetv1.prototype.forwardInput = function (input) {
    ...
    return tf.tidy(function () {
      ...
      var _a = predictionLayer_1.predictionLayer(
          features.out,
          features.conv11,
  ...
  SsdMobilenetv1.prototype.locateFaces = function (input, options) {
    ...
    return tslib_1.__awaiter(this, void 0, void 0, function () {
      ...
      return tslib_1.__generator(this, function (_e) {
        switch (_e.label) {
          case 0:
            (_a = new SsdMobilenetv1Options_1.SsdMobilenetv1Options(options)),
              (maxResults = _a.maxResults),
              (minConfidence = _a.minConfidence);
            return [
              4 /*yield*/,
              tfjs_image_recognition_base_1.toNetInput(input),
            ];
          ...
          case 2:
            ...
            iouThreshold = 0.5;
            indices = nonMaxSuppression_1.nonMaxSuppression(
              boxes,
              scoresData,
              maxResults,
              iouThreshold,
            ...
            results = indices.map(function (idx) {
              ...
              var _b = [
                ...
                left = _b[0],
                right = _b[1];
              return new FaceDetection_1.FaceDetection(
                scoresData[idx],
