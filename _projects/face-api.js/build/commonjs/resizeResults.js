...
function resizeResults(results, dimensions) {
  ...
  if (
    results instanceof FaceLandmarks_1.FaceLandmarks ||
    results instanceof FaceDetection_1.FaceDetection
  ) {
