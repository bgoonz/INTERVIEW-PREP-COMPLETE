...
var AgeGenderNet = /** @class */ (function (_super) {
  ...
  AgeGenderNet.prototype.runNet = function (input) {
    ...
    return tf.tidy(function () {
      var bottleneckFeatures =
        input instanceof tfjs_image_recognition_base_1.NetInput
      ...
      var age = fullyConnectedLayer_1
        ...
        .as1D();
      var gender = fullyConnectedLayer_1.fullyConnectedLayer(
        pooled,
        params.fc.gender
      );
        ...
        switch (_a.label) {
          ...
          case 2:
            ...
            return [
              4 /*yield*/,
              Promise.all(
                ageAndGenderTensors.map(function (_a) {
  ...
  AgeGenderNet.prototype.extractParamsFromWeigthMap = function (weightMap) {
    var _a = util_1.seperateWeightMaps(weightMap),
  ...
  AgeGenderNet.prototype.extractParams = function (weights) {
    ...
    var featureExtractorWeights = weights.slice(
      0,
      weights.length - classifierWeightSize
    );
    var classifierWeights = weights.slice(
      weights.length - classifierWeightSize
    );
