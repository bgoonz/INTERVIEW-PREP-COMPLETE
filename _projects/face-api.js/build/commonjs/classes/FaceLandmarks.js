...
var FaceLandmarks = /** @class */ (function () {
  function FaceLandmarks(relativeFaceLandmarkPositions, imgDims, shift) {
    if (shift === void 0) {
      shift = new tfjs_image_recognition_base_1.Point(0, 0);
    }
    ...
    this._positions = relativeFaceLandmarkPositions.map(function (pt) {
      return pt
        .mul(new tfjs_image_recognition_base_1.Point(width, height))
        .add(shift);
    });
  }
  ...
  FaceLandmarks.prototype.shiftBy = function (x, y) {
    return new this.constructor(
      ...
      this._imgDims,
      new tfjs_image_recognition_base_1.Point(x, y)
    );
  };
  ...
  FaceLandmarks.prototype.align = function (detection, options) {
    ...
    if (detection) {
      var box =
        detection instanceof FaceDetection_1.FaceDetection
          ? detection.box.floor()
  ...
  FaceLandmarks.prototype.alignDlib = function () {
    ...
    return new tfjs_image_recognition_base_1.Rect(
      x,
      y,
