...
var FaceLandmark68NetBase = /** @class */ (function (_super) {
  ...
  FaceLandmark68NetBase.prototype.postProcess = function (
    output,
    inputSize,
    originalDimensions
  ) {
    ...
    return tf.tidy(function () {
      var createInterleavedTensor = function (fillX, fillY) {
        return tf
          .stack([tf.fill([68], fillX), tf.fill([68], fillY)], 1)
          .as2D(1, 136)
          .as1D();
      };
      ...
      var landmarkTensors = output
        ...
        .sub(
          tf.stack(
            Array.from(Array(batchSize), function (_, batchIdx) {
              return createInterleavedTensor(
  ...
  FaceLandmark68NetBase.prototype.forwardInput = function (input) {
    ...
    return tf.tidy(function () {
      ...
      return _this.postProcess(
        out,
        input.inputSize,
        input.inputDimensions.map(function (_a) {
          var height = _a[0],
            width = _a[1];
        ...
        switch (_a.label) {
          ...
          case 1:
            ...
            return [
              4 /*yield*/,
              Promise.all(
                landmarkTensors.map(function (landmarkTensor, batchIdx) {
                      ...
                      switch (_c.label) {
                        ...
                        case 1:
                          ...
                          xCoords = landmarksArray.filter(function (_, i) {
                            return tfjs_image_recognition_base_1.isEven(i);
                          });
                          ...
                          return [
                            2 /*return*/,
                            new FaceLandmarks68_1.FaceLandmarks68(
                              Array(68)
                                .fill(0)
                                .map(function (_, i) {
