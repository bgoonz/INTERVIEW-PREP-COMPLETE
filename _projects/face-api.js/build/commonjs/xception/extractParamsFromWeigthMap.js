...
function loadParamsFactory(weightMap, paramMappings) {
  ...
  var extractConvParams =
    loadConvParamsFactory_1.loadConvParamsFactory(extractWeightEntry);
  var extractSeparableConvParams =
    tfjs_image_recognition_base_1.TfjsImageRecognitionBase.loadSeparableConvParamsFactory(
      extractWeightEntry
    );
