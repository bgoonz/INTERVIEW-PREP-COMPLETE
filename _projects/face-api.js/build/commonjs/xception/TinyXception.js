...
function reductionBlock(x, params, isActivateInput) {
  ...
  out = depthwiseSeparableConv_1.depthwiseSeparableConv(
    out,
    params.separable_conv0,
    [1, 1]
  );
  out = depthwiseSeparableConv_1.depthwiseSeparableConv(
    tf.relu(out),
...
function mainBlock(x, params) {
  var out = depthwiseSeparableConv_1.depthwiseSeparableConv(
    tf.relu(x),
    params.separable_conv0,
    [1, 1]
  );
...
var TinyXception = /** @class */ (function (_super) {
  ...
  TinyXception.prototype.forwardInput = function (input) {
    ...
    return tf.tidy(function () {
      ...
      var normalized = tfjs_image_recognition_base_1
      ...
      out = tf.relu(
        depthwiseSeparableConv_1.depthwiseSeparableConv(
          out,
          params.exit_flow.separable_conv,
          [1, 1]
        )
      );
      return out;
