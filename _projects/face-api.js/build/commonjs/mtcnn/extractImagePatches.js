      ...
      switch (_b.label) {
            ...
            Promise.all(
              boxes.map(function (box) {
                return tslib_1.__awaiter(_this, void 0, void 0, function () {
                  ...
                  return tslib_1.__generator(this, function (_b) {
                    (_a = box.padAtBorders(img.height, img.width)),
                      (y = _a.y),
                      (ey = _a.ey),
                      (x = _a.x),
                      (ex = _a.ex);
                    ...
                    return [
                      2 /*return*/,
                      tfjs_image_recognition_base_1.env.isNodejs()
                        ? tfjs_image_recognition_base_1.createCanvasFromMedia(
                            imgData
                          )
        ...
        case 1:
          ...
          bitmaps.forEach(function (bmp) {
            var patch = tfjs_image_recognition_base_1.createCanvas({
              width: width,
              height: height,
            });
            var patchCtx =
              tfjs_image_recognition_base_1.getContext2dOrThrow(patch);
