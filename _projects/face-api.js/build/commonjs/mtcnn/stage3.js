    ...
    return tslib_1.__generator(this, function (_c) {
      switch (_c.label) {
        case 0:
          ...
          return [
            4 /*yield*/,
            extractImagePatches_1.extractImagePatches(img, inputBoxes, {
              width: 48,
              height: 48,
            }),
          ];
        ...
        case 2:
          ...
          filteredRegions = indices.map(function (idx) {
            ...
            return new MtcnnBox_1.MtcnnBox(
              regionsData[0][0],
              regionsData[0][1],
              regionsData[0][2],
              regionsData[0][3]
          ...
          if (filteredBoxes.length > 0) {
            ts = Date.now();
            indicesNms = tfjs_image_recognition_base_1.nonMaxSuppression(
              filteredBoxes,
              filteredScores,
              0.7,
              false
