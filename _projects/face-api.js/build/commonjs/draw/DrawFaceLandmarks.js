...
var DrawFaceLandmarks = /** @class */ (function () {
  ...
  DrawFaceLandmarks.prototype.draw = function (canvasArg) {
    ...
    if (
      drawLines &&
      this.faceLandmarks instanceof FaceLandmarks68_1.FaceLandmarks68
    ) {
...
function drawFaceLandmarks(canvasArg, faceLandmarks) {
  var faceLandmarksArray = Array.isArray(faceLandmarks)
    ? faceLandmarks
    : [faceLandmarks];
  faceLandmarksArray.forEach(function (f) {
    var landmarks =
      f instanceof FaceLandmarks_1.FaceLandmarks
        ? f
        : WithFaceLandmarks_1.isWithFaceLandmarks(f)
        ? f.landmarks
        : undefined;
    if (!landmarks) {
      throw new Error(
