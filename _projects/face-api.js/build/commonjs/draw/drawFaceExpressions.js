...
function drawFaceExpressions(
  ...
  faceExpressionsArray.forEach(function (e) {
    var expr =
      e instanceof faceExpressionNet_1.FaceExpressions
        ? e
        : WithFaceExpressions_1.isWithFaceExpressions(e)
        ? e.expressions
        : undefined;
    if (!expr) {
      throw new Error(
    ...
    var drawTextField = new tfjs_image_recognition_base_1.draw.DrawTextField(
