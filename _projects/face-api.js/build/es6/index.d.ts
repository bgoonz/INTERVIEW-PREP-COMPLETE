...
declare const draw: {
  drawContour(
    ...
    points: import("tfjs-image-recognition-base").Point[],
    isClosed?: boolean
  ): void;
  drawDetections(
    canvasArg: string | HTMLCanvasElement,
    detections:
      | import("tfjs-image-recognition-base").IRect
      | import("tfjs-image-recognition-base").IBoundingBox
      | import("./classes").FaceDetection
      | {
          detection: import("./classes").FaceDetection;
        }
      | drawExtended.TDrawDetectionsInput[]
  ): void;
  drawFaceExpressions(
    canvasArg: string | HTMLCanvasElement,
    faceExpressions:
      | import("./faceExpressionNet").FaceExpressions
      | {
          expressions: import("./faceExpressionNet").FaceExpressions;
        }
      | drawExtended.DrawFaceExpressionsInput[],
    minConfidence?: number,
    textFieldAnchor?: import("tfjs-image-recognition-base").IPoint | undefined
  ): void;
  drawFaceLandmarks(
    canvasArg: string | HTMLCanvasElement,
    faceLandmarks:
      | import("./classes").FaceLandmarks
      | import("./factories").WithFaceLandmarks<
          {
            detection: import("./classes").FaceDetection;
          },
          import("./classes").FaceLandmarks68
        >
      | drawExtended.DrawFaceLandmarksInput[]
  ): void;
