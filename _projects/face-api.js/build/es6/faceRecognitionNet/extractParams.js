...
function extractorsFactory(extractWeights, paramMappings) {
  ...
  function extractResidualLayerParams(
    ...
    var conv1 = extractConvLayerParams(
      (isDown ? 0.5 : 1) * numFilterValues,
      numFilters,
      filterSize,
      mappedPrefix + "/conv1"
    );
    var conv2 = extractConvLayerParams(
      numFilterValues,
      numFilters,
      filterSize,
      mappedPrefix + "/conv2"
...
export function extractParams(weights) {
  ...
  var conv64_down = extractResidualLayerParams(
    36864,
    64,
    3,
    "conv64_down",
  ...
  var conv128_down = extractResidualLayerParams(
    147456,
    128,
    3,
    "conv128_down",
  ...
  var conv256_down = extractResidualLayerParams(
    589824,
    256,
    3,
    "conv256_down",
  ...
  var conv256_down_out = extractResidualLayerParams(
    589824,
    256,
    3,
    "conv256_down_out"
  ...
  var fc = tf.tidy(function () {
    return tf.transpose(
      tf.tensor2d(extractWeights(256 * 128), [128, 256]),
      [1, 0]
    );
  });
