...
export class Mtcnn extends NeuralNetwork<NetParams> {
  ...
  public async forwardInput(
    ...
    const imgTensor = tf.tidy(() =>
      bgrToRgbTensor(
        tf
          .expandDims(tf.browser.fromPixels(inputCanvas))
  ...
  public async forward(
    ...
    return (await this.forwardInput(await toNetInput(input), forwardParams))
      .results;
  }
