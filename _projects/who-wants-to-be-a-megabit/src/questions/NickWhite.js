export default [
  // #region Easy
  {
    ...
    correctAnswer: "6",
    incorrectAnswers: ["7", "3", "5"],
  },
  {
    questionText: "Which of the following is NOT a Node.js framework?",
    correctAnswer: "Neat",
    incorrectAnswers: ["Express", "Sails", "Hapi"],
  },
  {
    questionText:
      "In Java strings are immutable so when concatenating multiple strings together what class should you use?",
    correctAnswer: "StringBuilder",
    incorrectAnswers: ["StringBuffer", "String", "MutableString"],
  },
  {
    questionText:
      "Which of the following commands starts a Node.js REPL session?",
    correctAnswer: "node",
    incorrectAnswers: ["node console", "node repl", "node dev"],
  },
  {
    questionText:
      "Which of the following people has been fired or dumped at every occasion (as a millionaire)?",
    correctAnswer: `TechLead`,
    incorrectAnswers: [`Joma Tech`, `Nick White`, `Clever Programmer`],
  },
  // #endregion Easy
  // #region Medium
  {
...
console.log(10)`,
    ...
    incorrectAnswers: ["10 10", "null 10", "Throws an error"],
  },
  {
    questionText: "What is the WORST case time complexity of Quicksort?",
    correctAnswer: "n^2",
    incorrectAnswers: ["n", "n*log(n)", "n^3"],
  },
  {
  ...
  {
    questionText:
      "Which of the following is NOT true about a script loaded with the defer attribute?",
...
`,
  ...
  // #region Hard
  {
    ...
    incorrectAnswers: ["Ember", "React", "Angular"],
  },
  {
...
for (i = 0; i < 3; i++) {
  ...
  setTimeout(log, 100)
    ...
    correctAnswer: "3 3 3",
    incorrectAnswers: ["0 1 2", "2 2 2", "undefined undefined undefined"],
  },
  {
    ...
    correctAnswer: "291",
    incorrectAnswers: ["201", "18", "66"],
  },
  {
    questionText:
      "CSS 2 added a bunch of new media types which were later deprecated. Which of the following types is not an actual media type?",
    correctAnswer: "mobile",
    incorrectAnswers: ["braille", "aural", "tty"],
  },
  {
