...
import ValueChart from "../../../../src/blogComponents/referenceVsValue/ValueChart"
...
<ValueChart
  variables={{ a: 10, b: 20, c: "0x01", d: "0x01" }}
  memory={[["0x01", [1, 2]]]}
/>
