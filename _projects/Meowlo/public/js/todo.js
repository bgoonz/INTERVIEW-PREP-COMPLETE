class TodoList {
    ...
    get filteredTodos() {
        return this.todos.filter(todo => {
            ...
            const searchTextMatch = todo.text.toLowerCase().includes(this.searchText.toLowerCase())
...
const todoList = new TodoList(todoListElement, emptyMessageElement, summaryElement)
