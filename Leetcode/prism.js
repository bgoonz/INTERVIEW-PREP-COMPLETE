...
! function ( o ) {
  ...
  e = n( e ).source, o.languages.jsx = o.languages.extend( "markup", t ), o.languages.jsx.tag.pattern = n( "</?(?:[\\w.:-]+(?:<S>+(?:[\\w.:$-]+(?:=(?:\"(?:\\\\[^]|[^\\\\\"])*\"|'(?:\\\\[^]|[^\\\\'])*'|[^\\s{'\"/>=]+|<BRACES>))?|<SPREAD>))*<S>*/?)?>" ), o.languages.jsx.tag.inside.tag.pattern = /^<\/?[^\s>\/]*/i, o.languages.jsx.tag.inside[ "attr-value" ].pattern = /=(?!\{)(?:"(?:\\[^]|[^\\"])*"|'(?:\\[^]|[^\\'])*'|[^\s'">]+)/i, o.languages.jsx.tag.inside.tag.inside[ "class-name" ] = /^[A-Z]\w*(?:\.[A-Z]\w*)*$/, o.languages.jsx.tag.inside.comment = t.comment, o.languages.insertBefore( "inside", "attr-name", {
    spread: {
      pattern: n( "<SPREAD>" ),
      inside: o.languages.jsx
    }
  }, o.languages.jsx.tag ), o.languages.insertBefore( "inside", "attr-value", {
    script: {
      pattern: n( "=<BRACES>" ),
      inside: {
        "script-punctuation": {
    ...
    r = function ( t ) {
      for ( var n = [], e = 0; e < t.length; e++ ) {
        ...
        if ( "string" != typeof a && ( "tag" === a.type && a.content[ 0 ] && "tag" === a.content[ 0 ].type ? "</" === a.content[ 0 ].content[ 0 ].content ? 0 < n.length && n[ n.length - 1 ].tagName === i( a.content[ 0 ].content[ 1 ] ) && n.pop() : "/>" === a.content[ a.content.length - 1 ].content || n.push( {
            ...
            openedBraces: 0
          } ) : 0 < n.length && "punctuation" === a.type && "{" === a.content ? n[ n.length - 1 ].openedBraces++ : 0 < n.length && 0 < n[ n.length - 1 ].openedBraces && "punctuation" === a.type && "}" === a.content ? n[ n.length - 1 ].openedBraces-- : g = !0 ), ( g || "string" == typeof a ) && 0 < n.length && 0 === n[ n.length - 1 ].openedBraces ) {
          var s = i( a );
          e < t.length - 1 && ( "string" == typeof t[ e + 1 ] || "plain-text" === t[ e + 1 ].type ) && ( s += i( t[ e + 1 ] ), t.splice( e + 1, 1 ) ), 0 < e && ( "string" == typeof t[ e - 1 ] || "plain-text" === t[ e - 1 ].type ) && ( s = i( t[ e - 1 ] ) + s, t.splice( e - 1, 1 ), e-- ), t[ e ] = new o.Token( "plain-text", s, null, s )
        }
...
! function () {
  if ( "undefined" != typeof self && self.Prism && self.document ) {
    ...
    r.hooks.add( "before-highlightall", function ( e ) {
      ...
      if ( t.matches( p ) ) {
        ...
        o.open( "GET", i, !0 ), o.onreadystatechange = function () {
          4 == o.readyState && ( o.status < 400 && o.responseText ? ( t.setAttribute( g, u ), n.textContent = o.responseText, r.highlightElement( n ) ) : ( t.setAttribute( g, "failed" ), 400 <= o.status ? n.textContent = function ( e, t ) {
            return "✖ Error " + e + " while fetching file: " + t
          }( o.status, o.statusText ) : n.textContent = "✖ Error: File does not exist or is empty" ) )
        }, o.send( null )
      }
    } );
    ...
    r.fileHighlight = function () {
      e || ( console.warn( "Prism.fileHighlight is deprecated. Use `Prism.plugins.fileHighlight.highlight` instead." ), e = !0 ), r.plugins.fileHighlight.highlight.apply( this, arguments )
    }
  }
  ...
  if ( "undefined" != typeof self && self.Prism && self.document && document.createElement ) {
    ...
    Prism.hooks.add( "complete", function ( e ) {
      ...
      if ( a && r && "none" !== r ) {
        ...
        /^diff-./i.test( r ) ? ( s.push( "diff" ), s.push( r.substr( "diff-".length ) ) ) : s.push( r ), s.every( u ) || m( s, function () {
      ...
      ! function ( a, r, s ) {
        ...
        function e() {
          ...
          e || ( e = p[ a ] = {
            ...
            success: r,
            error: s
          } ), !t && u( a ) ? k( a, "success" ) : !t && e.error ? k( a, "error" ) : !t && e.loading || ( e.loading = !0, e.error = !1, function ( e, a, r ) {
  ...
  if ( "undefined" != typeof self && self.Prism && self.document ) {
    ...
    Prism.hooks.add( "before-highlight", function ( e ) {
      ...
      if ( !t.complete ) {
        ...
        else n = d( '<span data-user="' + u( "data-user", "user" ) + '" data-host="' + u( "data-host", "localhost" ) + '"></span>', r );
        var o = document.createElement( "span" );
      ...
      Prism.plugins.toolbar.registerButton( "copy-to-clipboard", function ( t ) {
        var o = t.element,
          e = function ( t ) {
            ...
            for ( var e in o ) {
              for ( var n = "data-prismjs-" + e, r = t; r && !r.hasAttribute( n ); ) r = r.parentElement;
          ...
          c.forEach( function ( e ) {
            ...
            c.forEach( function ( e ) {
              ...
              n.id = t + "open", c.id = t + "close", [ n, c ].forEach( function ( e ) {
                e.addEventListener( "mouseenter", p ), e.addEventListener( "mouseleave", v ), e.addEventListener( "click", m )
              } )
            } )
          } );
          var r = 0;
