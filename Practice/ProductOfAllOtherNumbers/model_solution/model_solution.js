...
// Tests
console.log(productOfAllOthers([1, 2, 3, 4, 5])); // should print [120, 60, 40, 30, 24]

console.log(productOfAllOthers([9, 90])); // sould print [90, 9]

console.log(productOfAllOthers([50])); // should print undefined
